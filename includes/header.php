    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            ...
            <div class="col-md-8 d-flex justify-content-end">
                ...
                <div class="header-item">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#"><i class="fa-solid fa-play"></i> Watch video
                                    tutuorials </a></li>
                            <li><a class="dropdown-item" href="#"><i class="fa-solid fa-question"></i> Visit the help
                                    center</a></li>

                        </ul>
                    </div>
                </div>
                <div class="header-item three-icons d-flex align-items-center">
                    <a href="javascript:;" type="button" class="btn " data-bs-toggle="tooltip"
                ...
                <div class="header-item profile-section">
                    <div class="profile">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#"><i class="fa-solid fa-person"></i> Profile</a></li>
                            <li><a class="dropdown-item" href="#"><i class="fa-solid fa-cog"></i> Settings</a></li>
                            <li><a class="dropdown-item" href="#"><i class="fa-solid fa-sign-out"></i> Logout</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="sidebar">
    ...
    <div class="add-section item d-none">

        <ul>
            <li><a href="">
                    <div class="icon"><i class="fa-solid fa-plus"></i></div> <span class="d-none">Add Section</span>
                    <div class="three-dots">...</div>
                </a> </li>
        </ul>
